  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row gap-6 p-2">
            ...
            <button
              ...
              className={`p-2.5 text-xs font-bold uppercase tracking-wider text-left rounded-xl transition-all border shrink-0 lg:shrink ${
                selectedPlanet.id === planet.id 
                  ? "bg-space-purple/20 border-space-cyan text-white shadow-[0_0_10px_rgba(0,212,255,0.2)]" 
      ...
      <div className="w-full lg:w-3/4 flex flex-col gap-6">
        <GlassCard className="flex-1 relative overflow-hidden flex items-center justify-center p-0 bg-black/60 border border-white/10 rounded-[2rem]">
